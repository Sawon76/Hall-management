...
const MinimalToggle = forwardRef(function MinimalToggle({ className, ...props }, ref) {
  return (
...
const OrangeToggle = forwardRef(function OrangeToggle({ className, ...props }, ref) {
  return (
    <input
      type="checkbox"
      ref={ref}
      className={cn(
        "ease before:ease relative h-6 w-12 cursor-pointer appearance-none rounded-full bg-stone-300",
